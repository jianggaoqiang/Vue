<template>
  <div class="wrapper">
    ...
    <div style="margin: 150px auto; background-color: #fff; width: 350px; height: 380px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="phone">
          <el-input placeholder="请输入手机号" size="medium" prefix-icon="el-icon-phone"  v-model="user.phone"></el-input>
        </el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        phone:[
          ...
          { min: 11, max: 11, message: '长度应为手机号正确格式', trigger: 'blur' }
        ]
      }
    }
  },
