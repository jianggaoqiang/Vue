<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-select v-model="role"  clearable placeholder="用户角色">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作"  width="200" align="center" >
        <template slot-scope="scope">
          <el-button v-show="scope.row.role !== 'ROLE_ADMIN'" type="success" @click="handleEdit(scope.row)">编辑 <i class="el-icon-edit"></i></el-button>
          <el-popconfirm
              v-show="scope.row.role !== 'ROLE_ADMIN'"
              class="ml-5"
              confirm-button-text='确定'
              cancel-button-text='我再想想'
              icon="el-icon-info"
