...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "springboot";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "C:\\Users\\jgq20\\Desktop\\springboot\\";

    // 数据库需要生成代码的表名
    private static final String tableName = "sys_conference_detail";
    // 生成页面的菜单名称
    private static final String modelName = "会议详情";

    // ----------------------------------------以上必修修改-----------------------------------------

    // 数据库密码 （填你自己的密码，默认 123456）
    private static final String PASSWORD = "zss204499";
